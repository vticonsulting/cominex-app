<template>
  <div>
    ...
    <h6>Heading 6</h6>
    <hr>
    <h1 id="headings-with-text">
      Headings with Text
    </h1>
    <h1>Heading 1</h1>
    <p>
      Lorem ipsum dolor sit amet, adipiscing elit. Nullam dignissim convallis est. Quisque aliquam. Donec faucibus.
      Nunc iaculis suscipit dui. Nam sit amet sem. Aliquam libero nisi, imperdiet at, tincidunt nec, gravida vehicula,
      nisl.
    </p>
    <h2>Heading 2</h2>
    <p>
    ...
    <p>
      Aliquam libero nisi, imperdiet at, tincidunt nec, gravida vehicula, nisl. Praesent mattis, massa quis luctus
      fermentum, turpis mi volutpat justo, eu volutpat enim diam eget metus. Maecenas ornare tortor.
    </p>
    <p>
      <img
        alt="Test Image"
    ...
    <p>
      Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam dignissim convallis est. Quisque aliquam. Donec
    ...
    <blockquote>
      "<strong>This is a blockquote.</strong> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam dignissim
      convallis est. Quisque aliquam. Donec faucibus. Nunc iaculis suscipit dui. Nam sit amet sem. Aliquam libero nisi,
      imperdiet at, tincidunt nec, gravida vehicula, nisl."
    </blockquote>
    <p>This is a standard paragraph. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
    <h2 id="figure-caption">
      Figure-Caption
    </h2>
    <figure>
      <img
    ...
    <p>
      The <a href="#">a element</a>, <a href="https://example.com" target="_blank">external a element</a>, and <a
        href="#" title="Example Title"
      >a element with title</a> examples
    </p>
    ...
    <video width="320" height="240" controls>
      ...
      >
      <track
        src="https://www.html5rocks.com/en/tutorials/video/basics/devstories-en.vtt" label="English subtitles"
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/l4f9QF0SGuQ" frameborder="0" allowfullscreen />
    <hr>
    <h1 id="form-elements">
      Form Elements
    </h1>
    ...
    <fieldset>
      ...
      <form>
        ...
        <p>
          <label for="text-field-disabled">Disabled Text Field:</label><br>
          <input id="text-field-disabled" type="text" disabled value="I'm disabled">
        </p>
        <p>
          <label for="text-field-readonly">Readonly Text Field:</label><br>
          <input id="text-field-readonly" type="text" readonly value="I'm readonly">
        </p>
        <p>
        ...
        <p>
          <label for="text-area-disabled">Disabled Text Area:</label><br>
          <textarea id="text-area-disabled" disabled>I'm disabled</textarea>
        </p>
        <p>
          <label for="text-area-readonly">Readonly Text Area:</label><br>
          <textarea id="text-area-readonly" readonly>I'm readonly</textarea>
        </p>
        <p>
          <label for="select-element">Select Element:</label><br>
        ...
        <p>
          <label for="select-element-disabled">Disabled Select Element:</label><br>
          <select id="select-element-disabled" disabled>
            <option value="1">
              Unselectable Option
            </option>
            <option value="2">
              This option should not even be seen
            </option>
          </select>
        </p>
        <p>
        ...
        <p>
          <label for="select_size">Select multiple [size="2"]</label><br>
        ...
        <p>Radio Buttons:</p>
        <div>
          <input id="radio-1" type="radio" name="radios" value="1" checked>
          <label for="radio-1">Radio 1</label>
        </div>
        <div>
          <input id="radio-2" type="radio" name="radios" value="2">
          <label for="radio-2">Radio 2</label>
        </div>
        <div>
          <input id="radio-3" type="radio" name="radios" value="3">
          <label for="radio-3">Radio 3</label>
        </div>
        <div>
          <input id="radio-4" type="radio" name="radios" value="4" disabled>
          <label for="radio-4">Radio Disabled</label>
        </div>
        <p>Checkboxes:</p>
        <div>
          <input id="checkbox-1" type="checkbox" name="checkboxes" value="1" checked>
          <label for="checkbox-1">Checkbox 1</label>
        </div>
        <div>
          <input id="checkbox-2" type="checkbox" name="checkboxes" value="2">
          <label for="checkbox-2">Checkbox 2</label>
        </div>
        <div>
          <input id="checkbox-3" type="checkbox" name="checkboxes" value="3">
          <label for="checkbox-3">Checkbox 3</label>
        </div>
        <div>
          <input id="checkbox-4" type="checkbox" name="checkboxes" value="4" disabled>
          <label for="checkbox-4">Checkbox Disabled</label>
        </div>
        <div>
          <input id="some-checkbox" type="checkbox" onclick="this.a=this.indeterminate=!this.a ">
        ...
        <div>
          <input
            ...
            onclick=" if (cb1.readOnly) cb1.checked = cb1.readOnly = false; else if (!cb1.checked) cb1.readOnly = cb1.indeterminate = true; "
          >
          <label for="cb1">

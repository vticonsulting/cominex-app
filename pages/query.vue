...
<template>
  <div>
    <header class="text-left">
      <p>
        The dataset in the <code class="inline">content/index.json</code> lists movies from Studio Ghibli. It is based
        on the <a href="https://ghibliapi.herokuapp.com/">Ghibli API</a>
      </p>
      <hr class="m-2">
    </header>
    <main>
